...
<title>Application | List all shifts</title>
		...
		<section id="main-content">
			<section class="wrapper">
				<div class="row" id="not-movable">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa fa-bars"></i>MonthLy Shifts
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
							<li><i class="fa fa-bars"></i>Shifts</li>
							<li><i class="fa fa-square-o"></i>Show Monthly Shifts</li>
						</ol>
					</div>
				</div>
				<!-- page start-->
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> List All Shifts </header>
							<div class="panel-body">
								<form class="form-horizontal">
									<!-- Get List Of Shifts starts -->
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="button" class="btn btn-default"
												value="List Shift" ng-click="listAllShiftData()" />
										</div>
									</div>
								</form>
							</div>
					...
					<div class="modal fade" id="list-shifts-response-modal"
					...
					<!-- Get the shift plan generator table -->
					<div class="container" id="list-shift-plan-table">
						<h3>{{month}} {{year}}</h3>
						<form id="list-shift-plan-generator-form">
							<table class="table table-bordered"
								id="list-shift-plan-generator-table">
								<thead>
									<tr>
										<th>Name</th>
										<th ng-repeat="(k,v) in individualShiftData[0]">{{k}}
											{{v.dayOfTheWeek}}</th>
									</tr>
								</thead>
								<tbody id="list-shift-plan-generator-table-row">
									<tr ng-repeat="names in individualShiftData">
										<td>{{names[1].name}}</td>
										<td ng-repeat="day in names track by $index"><select
											...
											class="form-control" style="width: 65px">
												<option class="afternoon"
													ng-selected="'A' == '{{day.shift}}'">A</option>
												<option class="morning" ng-selected="'M' == '{{day.shift}}'">M</option>
												<option class="night" ng-selected="'N' == '{{day.shift}}'">N</option>
												<option class="weeklyOff"
													ng-selected="'W' == '{{day.shift}}'">W</option>
										</select></td>
									</tr>
								</tbody>
							</table>
							<button id="saveEditedShiftPlan"
					...
					<!-- shift plan generator table ends here -->
				</div>
