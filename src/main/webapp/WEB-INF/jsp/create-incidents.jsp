...
<title>Application | Create incidents</title>
...
<body ng-app="shiftApp" ng-controller="create-incident-controller">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-file-text-o"></i> Create Incidents
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
							<li><i class="icon_document_alt"></i>Incidents</li>
							<li><i class="fa fa-file-text-o"></i>Create Incidents</li>
						</ol>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Create Incidents </header>
							<div class="panel-body">
								<form class="form-horizontal" name="create-incident-form"
									id="create-incident-form" method="post"
									ng-submit="saveIncident()">

									<!-- Modal Body to return success or failure status -->
									<div class="modal fade" id="create-incident-response-modal"
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<select class="form-control round-input"
												...
												<option value="Oppenheimer Funds">Oppenheimer Funds</option>
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Acknowledged By</label>
										<div class="col-sm-5">
											<input type="text" name="acknowledgedBy"
												class="form-control round-input">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Assignee Name</label>
										<div class="col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" name="issueDate"
												class="form-control round-input" id="issueDate">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Current Status</label>
										<div class="col-sm-5">
											<select class="form-control round-input" name="currentStatus">
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" name="issueSummary"
												class="form-control round-input">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Issue
											Description</label>
										<div class="col-sm-5">
											<input type="text" name="issueDescription"
												class="form-control round-input"
												placeholder="click to get date time calendar">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Comments on
											Resolution</label>
										<div class="col-sm-5">
											<input type="text" name="commentsOnResolution"
												class="form-control round-input">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="number" name="timeSpent" placeholder="In Hours"
												class="form-control round-input">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Linked Jira (if
											any)</label>
										<div class="col-sm-5">
											<input type="text" name="linkedJira"
												class="form-control round-input">
										</div>
									</div>
	...
	<script type="text/javascript" src="custom-js/create-incidents.js"></script>
	<script
