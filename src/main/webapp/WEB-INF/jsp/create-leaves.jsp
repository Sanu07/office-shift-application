...
<title>Application | Create leaves</title>
...
<body ng-app="shiftApp" ng-controller="create-leave-controller" ng-cloak>
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-file-text-o"></i> Apply Leave
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
							<li><i class="icon_document_alt"></i>Leaves</li>
							<li><i class="fa fa-file-text-o"></i>Apply Leave</li>
						</ol>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							...
							<div class="panel-body">
								<form class="form-horizontal" id="create-leave-form"
									method="post" ng-submit="saveLeave()">

									<!-- Modal Body to return success or failure status -->

									<div class="modal fade" id="create-leave-response-modal"
									...
									<!-- Create Leave Form starts  -->
									<div class="form-group">
										<label class="col-sm-2 control-label">Cognizant ID</label>
										<div class="col-sm-5">
											<input type="text" name="cognizantId" value="{{cognizantId}}"
												disabled="disabled" class="form-control round-input">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Select Leave
											Type</label>
										<div class="col-sm-5">
											<select class="form-control round-input" name="leaveType">
	...
	<script type="text/javascript" src="custom-js/create-leaves.js"></script>
	<script
