...
<title>Application | List WSR details</title>
...
<body ng-app="shiftApp" ng-controller="list-wsr-controller"
	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper">
				<div class="row" id="not-movable">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa fa-bars"></i> WSR Details
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
							<li><i class="fa fa-bars"></i>WSR</li>
							<li><i class="fa fa-square-o"></i>List WSR Details</li>
						</ol>
					</div>
				</div>
				<!-- page start-->
				<div>
					<h2>
						WSR For <span>{{wsrResponse[0].wsrdate}}</span>
					</h2>
				</div>
				<table class="table table-bordered" style="width: 1000px">
					<thead>
						<tr>
							...
							<th ng-click="sort('cognizantId')">Cognizant ID <span
								class="fa fa-sort"></span>
							</th>
							<th>WSR - Date</th>
							<th>Worked On</th>
					...
					<tbody>
						<tr ng-repeat="data in wsrResponse">
							<td>{{data.userName}}</td>
				...
				<!--  <span><a class="fa fa-download" href="/wsrDetails/{{wsrResponse[0].wsrdate}}" >Download As PPT</a></span>-->
				<!-- page end-->
			</section>
		</section>
		<!--main content end-->
	...
	<script src="custom-js/create-wsr.js"></script>
