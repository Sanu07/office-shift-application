...
<title>Application | List all jiras</title>
...
<body ng-app="shiftApp" ng-controller="list-jira-controller"
				...
				<div class="row" id="not-movable">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa fa-bars"></i> Jiras
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
							<li><i class="fa fa-bars"></i>Jiras</li>
							<li><i class="fa fa-square-o"></i>List All Jiras</li>
						</ol>
					</div>
				</div>
				<!-- page start-->
									...
									<div class="modal-body">
										<table class="table">
											<tbody>
												...
												<tr>
													<td>Issue Summary :</td>
													<td><input ng-model="issueSummary"
														class="form-control round-input" /></td>
												</tr>
												<tr>
													<td>Comments :</td>
													<td><input ng-model="comments"
														class="form-control round-input" /></td>
												</tr>
											</tbody>
										</table>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th ng-click="sort('jiraNumber')">Jira Number <span
					...
					<tbody>
						<tr
							dir-paginate="data in jiraListResponse.data | orderBy:sortKey:reverse | searchFor:searchString | itemsPerPage:5">
							<td>{{data.applicationName}}</td>
							<td>{{data.jiraNumber}}</td>
							<td>{{data.assigneeName}}</td>
							<td>{{data.currentStatus}}</td>
							<td>{{data.updatedBy}}</td>
							<td style="width: 500px">{{data.issueSummary}}</td>
							<td style="width: 500px">{{data.comments}}</td>
							<td><button class="btn btn-default" id="edit-jira"
									ng-click="editJira(this)">Edit</button></td>
							<td><button class="btn btn-default" id="delete-jira"
									ng-click="deleteJira(this)">Delete</button></td>
						</tr>
					</tbody>
				</table>
	...
	<script src="custom-js/create-jiras.js"></script>
	<script
