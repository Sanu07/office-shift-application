...
<title>Application | List all leaves</title>
			...
			<section class="wrapper">
				<div class="row" id="not-movable">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa fa-bars"></i>All Leaves
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
							<li><i class="fa fa-bars"></i>Leaves</li>
							<li><i class="fa fa-square-o"></i>Leave Approval</li>
						</ol>
					</div>
				</div>
				<!-- page start-->
				<div class="container">
					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr
								dir-paginate="data in leavesListResponse.data | itemsPerPage:5">
								<td>{{data.name}}</td>
								...
								<td><button class="btn btn-success" name="approveButton"
										id="approve" ng-click="approveLeave(this)">Approve</button></td>
								<td><button class="btn btn-danger" name="rejectButton"
										id="reject" ng-click="rejectLeave(this)">Reject</button></td>
							</tr>
						</tbody>
					</table>
