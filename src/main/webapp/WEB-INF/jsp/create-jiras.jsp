...
<title>Application | Create jiras</title>
...
<body class="row" ng-app="shiftApp"
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-file-text-o"></i> Create Jira
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
							<li><i class="icon_document_alt"></i>Jiras</li>
							<li><i class="fa fa-file-text-o"></i>Create Jiras</li>
						</ol>
					</div>
				</div>
				<div>
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Create Jira </header>
							<div class="panel-body">
								<form class="form-horizontal" id="create-jira-form"
									method="post" ng-submit="saveJira()">

									<!-- Modal Body to return success or failure status -->

									<div class="modal fade" id="create-jira-response-modal"
										tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header" style="color: {{resposeColor">
													{{responseMessage}}
									...
									<!-- Create Jira Form starts  -->
									<div class="form-group">
										<label class="col-sm-2 control-label">Jira Number</label>
										<div class="col-sm-5">
											<input type="text" name="jiraNumber"
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Deployment Date</label>
										<div class="col-sm-5">
											<input type="date" name="deploymentDate"
												class="form-control round-input">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" name="timeSpent" placeholder="in hours..."
												class="form-control round-input">
										</div>
									</div>
	...
	<script type="text/javascript" src="custom-js/create-jiras.js"></script>
